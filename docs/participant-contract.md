...
benchmarker forwards the socket name only from a channel published on or after
2026-09-05; an older channel binary removes it, the worker then serves in its own
