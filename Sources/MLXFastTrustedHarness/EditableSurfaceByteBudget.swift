...
public enum EditableSurfaceByteBudget {
    ...
    /// batching/round-driving engine joins the qwen3.8-125b-a6b-mlx-v1
    ...
    /// from the surface (the fork is a submodule now, and its files are not
    /// editable), leaving the Metal kernel sources and
    ...
    /// (9,447,153) leaves ~15.4 MB of headroom under the platform cap.
    ///
