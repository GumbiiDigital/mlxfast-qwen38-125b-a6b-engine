...
KEY="correctness_prompts/qwen3.8-125b-a6b-mlx-v1/test-object.json"
...
cat > "${WORK}/armed/fixtures/qwen3_8_125b_a6b_track.json" <<ARMEDJSON
{
  "timed_prompt_pool": [
    {
      "r2_path": "correctness_prompts/qwen3.8-125b-a6b-mlx-v1/armed-pool-object.json",
...
ARMED_KEY="correctness_prompts/qwen3.8-125b-a6b-mlx-v1/armed-pool-object.json"
if R2_BUCKET_ENDPOINT="${ENDPOINT}" "${WORK}/armed/tools/fetch-goldens-loopback.sh" \
...
' "${SCRIPT_DIR}/fixtures/qwen3_8_125b_a6b_track.json")"
if [[ -z "${SENTINEL_KEY}" ]]; then
  fail "case 5: could not read a timed_prompt_pool r2_path out of the shipped fixture"
...
out="${WORK}/case9.json"
if R2_BUCKET_ENDPOINT="${ENDPOINT}" "${RELAXED}" \
     --r2-path "correctness_prompts/qwen3.8-125b-a6b-mlx-v1/absent.json" \
...
ALL_KEY_A="correctness_prompts/qwen3.8-125b-a6b-mlx-v1/all-pool-a.golden.json"
ALL_KEY_B="correctness_prompts/qwen3.8-125b-a6b-mlx-v1/all-pool-b.golden.json"
ALL_KEY_C="correctness_prompts/qwen3.8-125b-a6b-mlx-v1/all-oracle-mtp1.golden.json"
