...
# for track qwen3.8-125b-a6b-mlx-v1, keyed on {r2_path, sha256, bytes}.
#
# ---------------------------------------------------------------------------
...
#     the pinned Vontra/Qwen3.8-Flash-Next-MLX-4bit-MTP @ 327c8a60), and it
...
so a failed run never leaves half-verified bytes behind.
  ...
  --r2-path KEY   Object key, e.g. correctness_prompts/qwen3.8-125b-a6b-mlx-v1/NAME.json
...
fixtures/qwen3_8_125b_a6b_track.json. Those objects are organizer-side: the GETs
